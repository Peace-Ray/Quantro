...
class LooselyBoundedArray_boolean_2 extends LooselyBoundedArray {

	boolean [][] ar ;
	
	LooselyBoundedArray_boolean_2( boolean [][] ar ) {
		super( ar, 2 ) ;
		this.ar = ar ;
	}
	...
	public LooselyBoundedArray clear() {
		...
		if ( min_0 == Integer.MIN_VALUE || min_1 == Integer.MIN_VALUE )
			return this ;
