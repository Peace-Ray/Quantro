...
public class HeavyShadowEditText extends MagicEditText {

	public HeavyShadowEditText(Context context) {
		super(context);
		init(context) ;
	}
	public HeavyShadowEditText(Context context, AttributeSet attrs) {
		super(context, attrs);
		init(context) ;
	}
	public HeavyShadowEditText(Context context, AttributeSet attrs, int defStyle) {
